...
!*****************************************************************************************
    ...
    !  SOURCE
        ...
        call initialize_ephemeris(ephemeris_file)
        ...
        do i = t0_days, tf_days, delta_t_days            ! departure epoch loop
            ...
            call get_state(jd_departure,3,11,rv_earth_departure)    ! state of earth at departure
            ...
            do j = dt0_days, dtf_days, dt_step_days      ! flight time loop    
                ...
                call get_state(jd_arrival,4,11,rv_mars_arrival)     ! state of mars at arrival
