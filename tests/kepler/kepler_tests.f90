...
!  Propagate a state using the various kepler methods and compare.
    ...
    character(len=*),dimension(3),parameter :: methods = ['gooding ',&
                                                          'shepperd',&
                                                          'goodyear'] !! method names
    ...
    real(wp),dimension(3,n_cases) :: pos_err,vel_err
    integer,dimension(3,n_cases) :: istats
        ...
        do i = 1, n_cases
            ...
            do imethod = 1,3
                ...
                if (istats(imethod,i) /= 0 .or. pos_err(imethod,i)>one .or. vel_err(imethod,i)>one) then
                    ...
                    write(*,'(A,1X,*(E30.17))')    'sma  (km)      = ', mu / e(1)
