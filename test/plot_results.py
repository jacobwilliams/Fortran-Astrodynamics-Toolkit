...
plot_traj('../../bin/shortway_n=0_s=1.txt','k')
plot_traj('../../bin/longway_n=0_s=1.txt','k--')
plot_traj('../../bin/shortway_n=1_s=1.txt','b')
plot_traj('../../bin/longway_n=1_s=1.txt','b--')
plot_traj('../../bin/shortway_n=1_s=2.txt','r')
plot_traj('../../bin/longway_n=1_s=2.txt','r--')
